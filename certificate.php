...
<html lang="en" class="no-js">
   ...
   <body>
      ...
      <div id="container">
		 ...
		 <br><br>
		 <h1 style="font-weight: 600;">Certificate</h1>
		 <p class="detailText"> Design and generate student certificate and ID Card here.</p>
		 
		 </div>
		 <br /><br /><br />
		 <div class="col-md-3">
		 <div class="vertical-menu">
		 <a href="#" class="firstOption">Student certificate</a>
		 <a href="#" class="secondOption">Generate Certificate</a>
		 <a href="#" class="thirdOption">Student ID card</a>
		 <a href="#" class="fourthOption">Generate ID card</a>

		 </div>
		 </div>
		 <div class="col-md-4" style="text-align:left;">
		 <h3 style="font-weight: 600;" id="moduleDetailHeading">Student certificate</h3>
		 
		 <p class=" moduleTextDetail" id="moduleTextDetail">
		 
			Student Certificate enter Certificate Name (certificate name is only for certificate design reference purpose it will not be print on actual certificate), Header Left Text, Header Center Text, Header Right Text, Body Text (enter specified keywords for replacingstudent data dynamically at time of certificate generation), Footer Left Text, Footer Center Text, Footer Right Text, Certificate Design - Header Height, Footer Height, Body Height, Body Width, Student Photo, Photo Height and Background Image then click on Save button. In certificate design we will suggest you to try to edit certificate design parameters by edit as many time possible until you will get your perfect design. You have to adjust many time design parameters to get your perfect design. While adjusting design parameters take browser final print preview or print as pdf option from browser as final reference of print design by using Generate Certificate link. Otherwise in final print you will get little bit deviation in design. All Certificate designs can be see right side of this page.
		 ...
		 <div class="col-md-5">
		 <img alt="" id="change-image" src="images/moduleDetail/Certificate/1.PNG" style="width:100%;">
		 <!-- The Modal -->
      ...
      <!-- End Container -->
	  	   <script type="text/javascript">
						...
						$('.firstOption').on({
							 'click': function(){
								 $('#change-image').attr('src','images/moduleDetail/Certificate/1.PNG');
								 $('#moduleDetailHeading').text('Student certificate');
								 $('#moduleTextDetail').text('Student Certificate enter Certificate Name (certificate name is only for certificate design reference purpose it will not be print on actual certificate), Header Left Text, Header Center Text, Header Right Text, Body Text (enter specified keywords for replacingstudent data dynamically at time of certificate generation), Footer Left Text, Footer Center Text, Footer Right Text, Certificate Design - Header Height, Footer Height, Body Height, Body Width, Student Photo, Photo Height and Background Image then click on Save button. In certificate design we will suggest you to try to edit certificate design parameters by edit as many time possible until you will get your perfect design. You have to adjust many time design parameters to get your perfect design. While adjusting design parameters take browser final print preview or print as pdf option from browser as final reference of print design by using Generate Certificate link. Otherwise in final print you will get little bit deviation in design. All Certificate designs can be see right side of this page.');
							 }
						 });
						...
						$('.secondOption').on({
							 'click': function(){
								...
								$('#change-image').attr('src','images/moduleDetail/Certificate/2.PNG');
								$('#moduleDetailHeading').text('Generate Certificate');
								$('#moduleTextDetail').text('Generate Certificate here you can select students and certificate design to generate certificate for those students.');
						...
						$('.thirdOption').on({
							 'click': function(){
								 $('#change-image').attr('src','images/moduleDetail/Certificate/3.PNG');
								 $('#moduleDetailHeading').text('Student ID card');
								 $('#moduleTextDetail').text('Student ID Card select Background Image, Logo, Signature (principal or authorized person signature image),School Name, Address/Phone/Email, ID Card Title, Header Color(in hexadecimal code), Admission Number, Student Name, Class, Father Name,Mother Name, Student Address, Phone (student Phone), Date Of Birth and Blood Group then click on Save button. In id card design we will suggest you to try to edit id card design parameters by edit as many time possible until you will get your perfect design. You have to adjust many time design parameters to get your perfect design. While adjusting design parameters take browser final print preview or print as pdf option from browser as final reference of print design from Generate ID Card link. Otherwise in final print you will get little bit deviation in design. All id card designs can be see right side of this page.');
						...
						$('.fourthOption').on({
							 'click': function(){
								$('#change-image').attr('src','images/moduleDetail/Certificate/4.PNG');
								$('#moduleDetailHeading').text('Generate ID card');
								$('#moduleTextDetail').text('Generate ID Card here you can select students and id card design to generate id card for those students.');
							 }
